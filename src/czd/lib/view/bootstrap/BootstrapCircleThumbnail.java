package czd.lib.view.bootstrap;
...
public class BootstrapCircleThumbnail extends FrameLayout {
	...
	private void initialise(AttributeSet attrs) {
		...
		else
		{
			...
			Bitmap roundBitmap = ImageUtil.getCircleBitmap(bitmap, imageSizeWidthPX, imageSizeHeightPX);
	...
	public void setImage(int drawable) {
		...
		Bitmap roundBitmap = ImageUtil.getCircleBitmap(bitmap, widthPX, heightPX);
		image.setImageBitmap(roundBitmap);
