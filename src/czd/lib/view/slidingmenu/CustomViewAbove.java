package czd.lib.view.slidingmenu;
...
import czd.lib.view.slidingmenu.SlidingMenu.OnClosedListener;
import czd.lib.view.slidingmenu.SlidingMenu.OnOpenedListener;
	...
	protected boolean canScroll(View v, boolean checkV, int dx, int x, int y) {
		if (v instanceof ViewGroup) {
			...
			for (int i = count - 1; i >= 0; i--) {
				...
				if (x + scrollX >= child.getLeft() && x + scrollX < child.getRight() && y + scrollY >= child.getTop() && y + scrollY < child.getBottom() && canScroll(child, true, dx, x + scrollX - child
						.getLeft(), y + scrollY - child.getTop())) {
					return true;
				}
			}
		}
